 ...
 * <p/>
 * Interceptor that is based off of {@link GaeMultiPartRequestWrapper}, which is automatically applied for any request that
 ...
 * patterns above, such as setDocument(String document), setDocumentContentType(String contentType), etc.
 ...
 * </pre>
 * <p/>
 * And then in your action code you'll have access to the content of the file object if you provide setters according to the
